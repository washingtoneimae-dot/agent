...
class Settings(BaseSettings):
    ...
    def active_ai_config(self) -> dict:
        if self.ai_provider == "deepseek":
            return {
                "provider": "deepseek",
                "api_key": self.deepseek_api_key or self.openrouter_api_key,
            ...
            return {
                "provider": "openai",
                "api_key": self.openai_api_key or self.openrouter_api_key,
            ...
            return {
                ...
                "model": self.ai_model or "deepseek/deepseek-chat",
            }
